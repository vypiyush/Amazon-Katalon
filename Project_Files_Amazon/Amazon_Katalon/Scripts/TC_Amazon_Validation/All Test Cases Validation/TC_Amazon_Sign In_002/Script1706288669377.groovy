...
WebUI.setText(findTestObject('Object Repository/Amazon_Sign In_OR/Page_Amazon Sign-In/input_email'), '10raj.piyush@gmail.com')

WebUI.click(findTestObject('Object Repository/Amazon_Sign In_OR/Page_Amazon Sign-In/inputcontinue'))

WebUI.setEncryptedText(findTestObject('Object Repository/Amazon_Sign In_OR/Page_Amazon Sign-In/input_password'), 'HWHXedaqLCe1Rel1H9AXeg==')
